...
const (
	hostKey       = "FACTUURHUB_HOST"
	portKey       = "FACTUURHUB_PORT"
	dbHostKey     = "FACTUURHUB_DB_HOST"
	dbPortKey     = "FACTUURHUB_DB_PORT"
	dbNameKey     = "FACTUURHUB_DB_NAME"
	dbUserKey     = "FACTUURHUB_DB_USER"
	dbPasswordKey = "FACTUURHUB_DB_PASSWORD"
	jwtSecretKey  = "FACTUURHUB_JWT_SECRET"
)
